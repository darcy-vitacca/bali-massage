...
export default function Home() {
  return (
    <>
      <Head>
        <title>Made Massage - Bali Home massages</title>
        <meta
          name="description"
          content="Feeling tired and stressed out? Get massages instantly to your
            villa/hotel in Bali. With over 100 years of experience, get an authentic Balinese massage
